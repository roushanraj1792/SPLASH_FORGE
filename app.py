...
if not st.session_state.authenticated:
    ...
    with login_col:
        with st.container():
            ...
            if st.button("Access SPLASH FORGE SOC", type="primary", use_container_width=True, key="btn_login_submit"):
...
if selected_page == "Dashboard":
    ...
    with st.expander("⚡ Interactive Threat Simulation & Attack Scenarios (Presenter Mode)", expanded=False):
        st.markdown(
            ...
            <div style="font-size:0.80rem; color:#94A3B8; margin-bottom:8px;">
                Inject realistic multi-stage cyberattack telemetry directly into the SPLASH FORGE pipeline to demonstrate real-time heuristic detection, explainable risk scoring, and automated host isolation.
            </div>
            """,
            unsafe_allow_html=True
        )
        ...
        with sim_cols[2]:
            ...
            if st.button("🚀 Full Multi-Stage Campaign", key="demo_sim_all", type="primary", use_container_width=True):
                with st.spinner("Injecting complete multi-stage cyberattack campaign..."):
                    ...
                    generate_privilege_escalation_events()
                    generate_suspicious_powershell_events()
                    st.success("Complete 5-stage attack campaign injected into SPLASH FORGE.")
                    st.rerun()
    ...
    st.markdown("### ⚡ SPLASH FORGE Core Pipeline Health")
        ...
        <div style="margin-bottom: 12px;">
            <div style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:8px;">
                <div>
                    ...
                    <div style="font-size: 0.76rem; color: #94A3B8; margin-top: 2px;">
                        Real-time security telemetry and host audit events ingested into the SPLASH FORGE processing pipeline.
                    </div>
                </div>
    ...
    if events:
        ...
        st.markdown(
            ...
            <div class="sx-empty-card">
                ...
                <div class="sx-empty-desc">
                    SPLASH FORGE has not received telemetry events yet. Launch an attack simulation or ingest host logs to populate the pipeline.
                </div>
            </div>
            """,
            unsafe_allow_html=True
...
# ==================================================
    ...
    st.markdown(
        ...
        <div style="margin-bottom: 12px;">
            ...
            <div style="font-size: 0.76rem; color: #94A3B8; margin-top: 2px;">
                Prioritized detections generated by SPLASH FORGE detection engines and risk scoring.
            </div>
        </div>
        """,
        unsafe_allow_html=True
            ...
            with st.container(border=True):
                ...
                if incident_for_alert:
                    ...
                    if incident_status in ["CONTAINED", "RESOLVED"]:
                        st.success("🛡️ SPLASH FORGE automated containment policy has been recorded for this incident.")
                    elif risk_level in ["HIGH", "CRITICAL"]:
                        st.warning("⚠️ High-risk alert requires active SOC investigation and containment according to SPLASH FORGE policy.")
                    else:
    ...
    if incidents:
        ...
        if filtered_incidents:
            ...
            for incident in filtered_incidents:
                ...
                with st.container(border=True):
                    ...
                    # AI SOC COPILOT
                    # ----------------------------------
                    st.markdown("### 🤖 SPLASH FORGE AI SOC Copilot")
                    ...
                    if cached_ai:
                        ...
                        st.caption(
                            ...
                            f"Provider: SPLASH FORGE Hybrid Copilot ({ai_source}) with Deterministic Guardrails"
                        )
        ...
        st.markdown(
            ...
            <div class="sx-empty-card">
                ...
                <div class="sx-empty-desc">
                    SPLASH FORGE has not created any security incidents yet. When suspicious telemetry triggers detection thresholds, incidents will appear here automatically.
                </div>
            </div>
            """,
            unsafe_allow_html=True
...
# ==================================================
    ...
    if containment_actions:
        ...
        # ----------------------------------------------
        with st.container(border=True):
            st.markdown("### 🛡️ SPLASH FORGE Safe Mitigation & Governance Policy")
            st.write(
                "All automated isolation and containment commands executed by SPLASH FORGE follow "
        ...
        st.markdown(
            ...
            <div class="sx-empty-card">
                ...
                <div class="sx-empty-desc">
                    SPLASH FORGE has not executed any host containment actions yet. When high-risk threats trigger containment policies, immutable execution logs will appear here.
                </div>
            </div>
            """,
            unsafe_allow_html=True
...
st.markdown(
    ...
    <div style="text-align:center; padding:10px 0; color:#64748B; font-size:0.75rem;">
        <b style="color:#94A3B8;">SPLASH FORGE</b> — Autonomous Security Operations Center Platform & Mini-SIEM<br>
        <span style="font-size:0.68rem; letter-spacing:0.5px; text-transform:uppercase;">From Security Event to Verified Response • Detection • Risk Scoring • MITRE ATT&CK • Gemini AI Investigation • Safe Containment • Forensic Audit</span>
    </div>
    """,
    unsafe_allow_html=True
)